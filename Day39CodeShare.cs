...
Build started...
Build succeeded.
Applying migration '20260302053128_added 3more tables'.
Done.
PM> 

Now i dont want to seed data using program.cs  through migration only i want to add data so for that 
