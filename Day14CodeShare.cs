 ...
 namespace structdemo
{
    ...
    {
        public int ID { set; get; }
         public string Name { set; get; }// here i cannot make protected do data hiding 
    ...
    internal class Program//:Student I cannot inherite so oops inheritance is not followed here 
    {
        static void Main(string[] args)
        {
            Student student1 = new Student(1, "ravi", 3);
