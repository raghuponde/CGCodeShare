...
------------
USE CG 
-- if table is there drop it and then create it 
...
Till now code after doing the configuration 
--------------------------------------------
using System;
...
namespace LnqToSqlDemo
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            db.Employees.InsertOnSubmit(emp);   // marks for INSERT
            db.SubmitChanges();                 // sends INSERT to SQL Server
            dataGridView1.DataSource = db.Employees.ToList();
